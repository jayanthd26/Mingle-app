...
@dso_cache = dso_local local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libmongocrypt.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"bead322c-c5ab-4653-8f7f-b8bbe150c984\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [17 x i8] c"libmongocrypt.so\00", align 16
